...
<template>
  <div>
    <div class="form-control clearfix">
      ...
      <v-input v-model="value" :placeholder="'请输入网址'" :icon="'user'" :style="{width: '300px', height: '40px', 'border-radius': '4px', 'border-color': '#ddd'}"></v-input>
      <v-input v-model="value" :placeholder="'请输入网址'" :icon="'email'" :style="{width: '300px', height: '40px', 'border-radius': '4px', 'border-color': '#ddd'}"></v-input>
      <v-input :require='true' v-model="value" :prefix="'www.'" :placeholder="'请输入网址'" :icon="'url'" :style="{width: '300px', height: '40px', 'border-radius': '4px', 'border-color': '#ddd'}"></v-input>
      <v-input v-model="value" :error="error" :placeholder="'请输入网址'" :icon="'password'" :style="{width: '300px', height: '40px', 'border-radius': '4px', 'border-color': '#ddd'}"></v-input>
      <v-input v-model="value" :tail="'.com'" :icon="'number'"></v-input>
      <v-input v-model="value" :prefix="'www.'" :tail="'.com'" :placeholder="'请输入网址'" :icon="'search'" :style="{width: '300px', height: '40px', 'border-radius': '4px', 'border-color': '#ddd'}"></v-input>
      <v-input v-model="value" :placeholder="'请输入网址'" :icon="'date'" :style="{width: '300px', height: '40px', 'border-radius': '4px', 'border-color': '#ddd'}"></v-input>
      <v-input v-model="value" :placeholder="'请输入网址'" :icon="'time'" :style="{width: '300px', height: '40px', 'border-radius': '4px', 'border-color': '#ddd'}"></v-input>
      <v-input v-model="value" :placeholder="'请输入网址'" :icon="'tel'" :style="{width: '300px', height: '40px', 'border-radius': '4px', 'border-color': '#ddd'}"></v-input>
      <v-input v-model="value" :placeholder="'请输入网址'" :icon="'phone'" :style="{width: '300px', height: '40px', 'border-radius': '4px', 'border-color': '#ddd'}"></v-input>
      <v-input v-model="value" :placeholder="'请输入网址'" :icon="'addr'" :style="{width: '300px', height: '40px', 'border-radius': '4px', 'border-color': '#ddd'}"></v-input>
      <v-input v-model="value" :placeholder="'请输入网址'" :icon="'dropdown'" :style="{width: '300px', height: '40px', 'border-radius': '4px', 'border-color': '#ddd'}"></v-input>
      <v-input readonly v-model="value" :placeholder="'请输入网址'" :icon="'dropdown'" :style="{width: '300px', height: '40px', 'border-radius': '4px', 'border-color': '#ddd'}"></v-input>
    </div>
    <div class="form-control clearfix">
      <label class="label">输入框使用(slot自定义)</label>
      <v-input v-model="value" type="number" :min="20" :max="500" :require='true' :icon="'number'" :style="{width: '300px', height: '40px', 'border-radius': '4px', 'border-color': '#ddd'}">
        <em slot="icon" class="tips">500</em>
      </v-input>
      <v-input disabled v-model="hello" :style="{width: '300px', height: '40px', 'border-radius': '4px', 'border-color': '#ddd'}">
        <em slot="icon" class="tips">128字</em>
      </v-input>
      <v-input :require='true' maxlength="4" :minLen='4' v-model="value" :style="{width: '300px', height: '40px', 'border-radius': '4px', 'border-color': '#ddd'}">
        <em slot="icon" class="tips">128字</em>
      </v-input>
    </div>
  ...
  methods: {
    ...
    getData () {
      this.table.data = [
        ...
        {arg: ':style', type: 'Object', desc: '定义样式，暂支持定义输入框宽高、圆角、边框颜色', must: 'false', exp: `{width: '300px', height: '40px', 'border-radius': '4px', 'border-color': '#ddd'}`, default: 'null'},
    ...
    go () {
      ...
      setTimeout(() => bling(), 3300)
      setTimeout(() => clear(), 4300)
      function scroll () {
        let timeGap = 16.7
        let totalTime = 300
